...
require('lazy').setup({
...

  {
    ...
    require('onedark').setup {
      style = 'warm',  -- You can choose between 'dark', 'darker', 'cool', 'deep', 'warm', 'warmer', 'light'
      transparent = true, -- Enable this to make the background transparent
      term_colors = true, -- Adjust terminal colors as well
      ending_tildes = false, -- Show the end-of-buffer tildes (~)
      toggle_style_key = '<leader>ts', -- Keybinding to toggle theme styles
      code_style = {
        comments = 'italic',
        keywords = 'bold',
      ...
      colors = {grey = "#dbc6b6"}, -- Override default colors
      highlights = {
...
vim.keymap.set('n', '<C-e>', ':Neotree<CR>', {silent = true, noremap = true})
